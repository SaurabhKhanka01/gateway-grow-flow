  ...
  return (
    <section id="ecosystem" className="py-12 sm:py-16 lg:py-20 bg-secondary/50">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          <span className="inline-block text-xs sm:text-sm font-body font-medium text-accent uppercase tracking-widest mb-2">Our Ventures</span>
        ...
        <div className="flex flex-wrap justify-center gap-1.5 sm:gap-2 mb-8">
          {filters.map((f) => (
            <button
              ...
              className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-full text-xs sm:text-sm font-body font-medium transition-all ${
                activeFilter === f
              ...
              <div className="grid sm:grid-cols-[1.2fr_1fr] gap-0">
                ...
                <div className="relative overflow-hidden">
                  ...
                  <img
                    ...
                    className="w-full h-40 sm:h-48 md:h-56 lg:h-64 object-cover object-top group-hover:scale-105 transition-transform duration-500"
                    loading="lazy"
                  />
                  <div className="absolute top-3 left-3">
                    <span className={`inline-block px-2.5 py-1 rounded-full text-[10px] sm:text-xs font-body font-semibold text-white bg-gradient-to-r ${brand.accent} shadow-sm`}>
                      {brand.category}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-4 sm:p-5 md:p-6 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="font-body text-xs sm:text-sm text-muted-foreground leading-relaxed mb-4 line-clamp-4 sm:line-clamp-none">
                      {brand.description}
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 px-4 py-2 bg-primary text-primary-foreground font-body font-semibold text-xs sm:text-sm rounded-lg sm:rounded-xl hover:bg-primary/90 transition-all shadow-sm"
                    >
                      Visit Website <ArrowUpRight size={12} />
                    </a>
                    <span className="text-[10px] sm:text-xs font-body text-muted-foreground flex items-center gap-1">
